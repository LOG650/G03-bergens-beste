...
linked_df = pd.read_csv('G03-bergens-beste/03_data/Koblede_Fly_15jun-29jun.csv', sep=';')
...
if mixed_rotations:
    ...
    mixed_df.to_csv('G03-bergens-beste/03_data/Statusendringer_Fly.csv', index=False, sep=';')
else:
